...
//Podemos manejar la memoria con apuntadores
...
//2 bytes podemos usar short int
...
//Usamos / para escribir dentro del segundo byte y % la usamos para poder escribir en 2 bytes el entero
...
//Tomamos datos del fichero y lo añadimos a su variable correspondiente si es un int
...
int main(void) {
   ...
   for(y = 0; y < header.height; y++)
      for(x = 0; x < header.width; x++) {
        unsigned char r, g, b, average, ly, ls;
        ...
        // Algoritmo 1:
        ls = (max(max(r,g),b)+min(min(r,g),b))/2;//lightness
        // Algoritmo 2:
        ly = r*0.21 + g*0.72 + b*0.07;//luminosity
        // Algoritmo 3:
        average = (r+g+b)/3;
